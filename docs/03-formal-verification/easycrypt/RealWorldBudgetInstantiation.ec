...
pred le_fs_concrete_128_reduction_obligation
  (x : qssm_public_input) (s : seed) =
  LEFsConcreteReduction.le_fs_concrete_reduction_obligation
    epsilon_le_fs_concrete_128 x s.

pred ms1_concrete_128_reduction_obligation
  (x : qssm_public_input) (s : seed) (D : distinguisher) =
  MS1ConcreteReduction.ms1_concrete_reduction_obligation
    epsilon_ms_hash_binding_concrete_128 x s (extract_ms_public x) D.

pred ms2_concrete_128_reduction_obligation
  (x : qssm_public_input) =
  MS2ConcreteReduction.ms2_concrete_reduction_obligation
    epsilon_ms_rom_programmability_concrete_128 (extract_ms_public x).
...
lemma qssm_main_theorem_realworld_concrete_128_with_le_reductions
  (x : qssm_public_input) (s : seed) (D : distinguisher) :
  le_rejection_concrete_128_reduction_obligation x s =>
  le_fs_concrete_128_reduction_obligation x s =>
  ms_hash_binding_execution_owned_parameterized_failure_probability (extract_ms_public x) <=
    epsilon_ms_hash_binding_concrete_128 =>
  ms_rom_execution_owned_parameterized_failure_probability (extract_ms_public x) <=
    epsilon_ms_rom_programmability_concrete_128 =>
...
lemma qssm_main_theorem_realworld_concrete_128_with_le_reductions_5_over_2_98
  (x : qssm_public_input) (s : seed) (D : distinguisher) :
  le_rejection_concrete_128_reduction_obligation x s =>
  le_fs_concrete_128_reduction_obligation x s =>
  ms_hash_binding_execution_owned_parameterized_failure_probability (extract_ms_public x) <=
...
proof.
move=> Hlej Hlefs Hms1 Hms2 Hsetb Hleeqv.
have Hmain := qssm_main_theorem_realworld_concrete_128_with_le_reductions
  x s D Hlej Hlefs Hms1 Hms2 Hsetb Hleeqv.
rewrite -epsilon_top_concrete_128_eq_5_over_2_98.
apply (ler_trans _ _ _ Hmain).
rewrite epsilon_top_concrete_128_closed_form.
...
lemma qssm_main_theorem_realworld_concrete_128_with_le_and_ms1_reductions
  (x : qssm_public_input) (s : seed) (D : distinguisher) :
  le_rejection_concrete_128_reduction_obligation x s =>
  le_fs_concrete_128_reduction_obligation x s =>
  ms1_concrete_128_reduction_obligation x s D =>
  ms_rom_execution_owned_parameterized_failure_probability (extract_ms_public x) <=
    epsilon_ms_rom_programmability_concrete_128 =>
  set_b_parameter_well_formed =>
  le_real_sim_transcript_equiv x s =>
...
have H01p : Adv_G0_G1_MS x xms s D <=
  ...
  exact (A_G0_to_G1_ms_concrete_reduction_transition_bound_from_ms1_obligation
    epsilon_ms_hash_binding_concrete_128 epsilon_ms_rom_programmability_concrete_128
    x xms s D Hms1 Hms2
    (use_MS_3a xms s)
    (use_MS_3b xms)
    (use_MS_3c xms s)).
...
lemma qssm_main_theorem_realworld_concrete_128_with_le_and_ms1_reductions_5_over_2_98
  (x : qssm_public_input) (s : seed) (D : distinguisher) :
  le_rejection_concrete_128_reduction_obligation x s =>
  le_fs_concrete_128_reduction_obligation x s =>
  ms1_concrete_128_reduction_obligation x s D =>
...
proof.
move=> Hlej Hlefs Hms1 Hms2 Hsetb Hleeqv.
have Hmain := qssm_main_theorem_realworld_concrete_128_with_le_and_ms1_reductions
  x s D Hlej Hlefs Hms1 Hms2 Hsetb Hleeqv.
rewrite -epsilon_top_concrete_128_eq_5_over_2_98.
apply (ler_trans _ _ _ Hmain).
rewrite epsilon_top_concrete_128_closed_form.
...
lemma qssm_main_theorem_realworld_concrete_128_with_all_reductions
  (x : qssm_public_input) (s : seed) (D : distinguisher) :
  le_rejection_concrete_128_reduction_obligation x s =>
  le_fs_concrete_128_reduction_obligation x s =>
  ms1_concrete_128_reduction_obligation x s D =>
  ms2_concrete_128_reduction_obligation x =>
  set_b_parameter_well_formed =>
  le_real_sim_transcript_equiv x s =>
  Adv_G0_G2_QSSM x (extract_ms_public x) s D <=
    epsilon_ms_hash_binding_concrete_128 +
...
lemma qssm_main_theorem_realworld_concrete_128_with_all_reductions_5_over_2_98
  (x : qssm_public_input) (s : seed) (D : distinguisher) :
  le_rejection_concrete_128_reduction_obligation x s =>
  le_fs_concrete_128_reduction_obligation x s =>
  ms1_concrete_128_reduction_obligation x s D =>
...
proof.
move=> Hlej Hlefs Hms1 Hms2 Hsetb Hleeqv.
have Hmain := qssm_main_theorem_realworld_concrete_128_with_all_reductions
  x s D Hlej Hlefs Hms1 Hms2 Hsetb Hleeqv.
rewrite -epsilon_top_concrete_128_eq_5_over_2_98.
apply (ler_trans _ _ _ Hmain).
rewrite epsilon_top_concrete_128_closed_form.
