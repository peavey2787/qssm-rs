...
pub use prover_package::{
    ...
    WitnessWireCountsV1, DIGEST_COEFF_MAX, DIGEST_COEFF_VECTOR_LEN, PROTOCOL_VERSION,
};
pub use package_builder::{TruthBuildOptions, TruthHandshakeArtifacts, TruthHandshakePackageBuilder};
pub use stream::{
...
mod tests {
    ...
    fn golden_acc_99_matches_spec() {
        ...
        let expected = "0x0a898b3b0a912cc90a1daba708c17cd286a96111d439f8ed872c4acaf83c30c4";
