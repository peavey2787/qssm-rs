...
use qssm_gadget::binding::{
    encode_proof_metadata_v2, message_limb_from_sovereign_digest_normative, sovereign_digest,
    SovereignWitness, DOMAIN_SOVEREIGN_LIMB_V2,
};
...
/// Locked: `hash_domain(DOMAIN_SOVEREIGN_LIMB_V2, &[GOLDEN_ROOT, GOLDEN_ROLLUP, golden_metadata_v2()])`.
...
fn tamper_one_bit_of_root_invalidates_witness() {
    let mut w = SovereignWitness::bind(
        GOLDEN_ROOT,
        GOLDEN_ROLLUP,
        7,
        11,
