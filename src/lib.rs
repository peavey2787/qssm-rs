...
pub use millionaires_duel::{
    ...
    public_message_for_duel, MillionairesDuelError, MillionairesDuelVerifier, MillionairesProofBundle,
    ProofWireError, WEALTHIEST_KNIGHT_TAG, DUEL_SHIFT, MAX_DEMO_BALANCE,
};
