...
proof.
move=> x s.
rewrite (le_rejection_shadow_semantic_failure_probability_eq_parameterized x s).
exact (le_rejection_shadow_semantic_failure_probability_le_epsilon_le_rej_parameterized x s).
qed.
