...
require import LERejectionSamplerSemanticFacts.
...
proof.
  exact (LERejectionSamplerSemanticFacts.le_rejection_shadow_semantic_reject_event_of_categoryE
    x s obs category).
qed.
...
lemma le_rejection_shadow_semantic_accept_event_of_categoryE
  ...
  ! BudgetParameters.le_rejection_semantic_ticket_category_is_failure category.
proof.
exact (LERejectionSamplerSemanticFacts.le_rejection_shadow_semantic_accept_event_of_categoryE
  x s obs category).
qed.
...
lemma le_rejection_shadow_semantic_post_observable_of_categoryE
  ...
  le_rejection_shadow_semantic_branch_image_of_observable x s obs
    (BudgetParameters.le_rejection_semantic_ticket_category_is_failure category).
proof.
exact (LERejectionSamplerSemanticFacts.le_rejection_shadow_semantic_post_observable_of_categoryE
  x s obs category).
qed.
...
lemma le_rejection_shadow_semantic_post_observable_of_accept_categoryE
  ...
  obs.
proof.
exact (LERejectionSamplerSemanticFacts.le_rejection_shadow_semantic_post_observable_of_accept_categoryE
  x s obs).
qed.
...
lemma le_rejection_shadow_semantic_hidden_branch_bit_of_categoryE
  ...
  BudgetParameters.le_rejection_semantic_ticket_category_is_failure category.
proof.
exact (LERejectionSamplerSemanticFacts.le_rejection_shadow_semantic_hidden_branch_bit_of_categoryE
  x s obs category).
qed.
...
proof.
exact (LERejectionSamplerSemanticFacts.le_rejection_shadow_semantic_branch_state_has_support
  x s obs reject).
qed.
...
lemma le_rejection_shadow_semantic_accept_branch_support
  ...
  le_rejection_shadow_semantic_state_of_branch_execution x s
    ...
    \in d_le_rejection_shadow_semantic_coupled_state x s.
proof.
exact (LERejectionSamplerSemanticFacts.le_rejection_shadow_semantic_accept_branch_support x s).
qed.
...
lemma le_rejection_shadow_semantic_reject_branch_support
  ...
  le_rejection_shadow_semantic_state_of_branch_execution x s
    ...
    \in d_le_rejection_shadow_semantic_coupled_state x s.
proof.
exact (LERejectionSamplerSemanticFacts.le_rejection_shadow_semantic_reject_branch_support x s).
qed.
...
proof.
exact LERejectionSamplerSemanticFacts.d_le_rejection_shadow_semantic_pre_marginal_matches_real_view.
qed.
