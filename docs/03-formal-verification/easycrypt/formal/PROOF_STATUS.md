...
- primitive rejection owner counts are `le_rej_soft_repair_slot_count=1`, `le_rej_hard_repair_slot_count=1`, `le_rej_invalid_slot_count=1`, `le_rej_accept_slot_count=3`
- `le_rej_failure_slot_count = le_rej_soft_repair_slot_count + le_rej_hard_repair_slot_count + le_rej_invalid_slot_count = 3`
- `le_rej_total_slot_count = le_rej_accept_slot_count + le_rej_failure_slot_count = 6`
