...
| `A_ms3a_seed_pair_stmt_on_support`, `A_ms3a_seed_pair_res_on_support`, `A_ms3a_seed_pair_comparison_global_on_support`, `A_ms3a_seed_pair_bitness_globals_on_support` | **Axioms** (`SourceObligations.ec`) — one public-field obligation per conjunct of `ms3a_payload_pair_public_fields_match` on joint seed support |
| `A_ms3a_seed_pair_public_fields_on_support` | **Proved lemma** (`SourceObligations.ec`) — combines the four field axioms (replaces the former single axiom of the same name) |
...
| Seed support (paired **public** fields on joint seed support) | **Axioms** `A_ms3a_seed_pair_stmt_on_support`, `A_ms3a_seed_pair_res_on_support`, `A_ms3a_seed_pair_comparison_global_on_support`, `A_ms3a_seed_pair_bitness_globals_on_support` (`ms/source/SourceObligations.ec`); **lemma** `A_ms3a_seed_pair_public_fields_on_support` combines them into `ms3a_payload_pair_public_fields_match` for `from_seed` |
