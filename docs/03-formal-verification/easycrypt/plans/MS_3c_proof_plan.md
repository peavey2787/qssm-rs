...
- **MS-3c closure / handoff:** the comparison hop is now closed at the game boundary. No further MS-3c game-layer axiom is needed, and the remaining MS game-layer assumption debt sits in the narrower MS1/MS2 obligations in **`games/GameMSHopTypes.ec`** rather than in the comparison lane.
