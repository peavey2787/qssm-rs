...
* [QSSM-Entropy crate guide](./heart-he.md) (hardware entropy path)
...
> **Scope:** This crate does **not** implement raw hardware harvest; that lives in **`qssm-entropy`** (see [heart-he.md](./heart-he.md)).
